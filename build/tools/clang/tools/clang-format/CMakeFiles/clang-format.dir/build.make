...
tools/clang/tools/clang-format/CMakeFiles/clang-format.dir/ClangFormat.cpp.o: /root/llvm-obfuscator/obfuscator/tools/clang/tools/clang-format/ClangFormat.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/llvm-obfuscator/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object tools/clang/tools/clang-format/CMakeFiles/clang-format.dir/ClangFormat.cpp.o"
	cd /root/llvm-obfuscator/build/tools/clang/tools/clang-format && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/clang-format.dir/ClangFormat.cpp.o -c /root/llvm-obfuscator/obfuscator/tools/clang/tools/clang-format/ClangFormat.cpp
...
tools/clang/tools/clang-format/CMakeFiles/clang-format.dir/ClangFormat.cpp.i: cmake_force
	...
	cd /root/llvm-obfuscator/build/tools/clang/tools/clang-format && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/llvm-obfuscator/obfuscator/tools/clang/tools/clang-format/ClangFormat.cpp > CMakeFiles/clang-format.dir/ClangFormat.cpp.i
...
tools/clang/tools/clang-format/CMakeFiles/clang-format.dir/ClangFormat.cpp.s: cmake_force
	...
	cd /root/llvm-obfuscator/build/tools/clang/tools/clang-format && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/llvm-obfuscator/obfuscator/tools/clang/tools/clang-format/ClangFormat.cpp -o CMakeFiles/clang-format.dir/ClangFormat.cpp.s
...
bin/clang-format: tools/clang/tools/clang-format/CMakeFiles/clang-format.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/llvm-obfuscator/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../../../bin/clang-format"
	cd /root/llvm-obfuscator/build/tools/clang/tools/clang-format && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/clang-format.dir/link.txt --verbose=$(VERBOSE)
...
tools/clang/tools/clang-format/CMakeFiles/clang-format.dir/clean:
	cd /root/llvm-obfuscator/build/tools/clang/tools/clang-format && $(CMAKE_COMMAND) -P CMakeFiles/clang-format.dir/cmake_clean.cmake
